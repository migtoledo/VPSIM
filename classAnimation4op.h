...
void Animation::opdraw()
{
	...
	switch (gmode)
	{
		...
		case 2:
			...
			textline2b = "[ %s ]";
			textline3a = "[ dt: %.3fs ]  [ XY-Scale (%.0fpx, %.0fpx) ]  [ (x, y) = (%.3f, %.3f) ]  [ Virtual-time: %.3fs ]  [ Gravity C. : %.4f v.u. ]  [ Electric C. : %.4f v.u. ]";
			textline3b = "";
			...
			// Line 5
			al_draw_textf(font, text_color, x0, Line5, ALLEGRO_ALIGN_LEFT, textline5);
		...
		case 4:
			...
			textline2a = "[ %.0f x %.0f ]          [ FPS: %.0f ]          [ Refresh-rate: %.3fs ]          [ Real-time: %.3fs ]";
			textline2b = "[ %s ]";
			textline3a = "[ dt: %.3fs ] [ XY-Scale (%.0fpx, %.0fpx) ] [ (x, y) = (%.2f, %.2f) ] [ Virtual-time: %.3fs ] [ Gravity C. : %.4f v.u. ] [ Electric C. : %.4f v.u. ]";
			textline3b = "";
		...
		case 5:
			...
			textline2a = "[ %.0f x %.0f ]          [ FPS: %.0f ]          [ Refresh-rate: %.3fs ]          [ Real-time: %.3fs ]";
			textline2b = "[ %s ]";
			textline3a = "[ dt: %.3fs ] [ XY-Scale (%.0fpx, %.0fpx) ] [ (x, y) = (%.2f, %.2f) ] [ Virtual-time: %.3fs ] [ Gravity Constant: %.4f v.u. ] [ Electric Constant: %.4f v.u. ]";
			textline3b = "";
			textline4a = "[ Particles: %.0f ]  [ Processors: %.0f ]  [ CenterMass = (%.2f, %.2f) ]  [ Temperature: %.2f t.u. ]  [ Velocity CenterMass =  (%.2f, %.2f) ]";
			textline4b = "";
			textline5 = "";
